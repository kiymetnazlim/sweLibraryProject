...
using LibraryProject10; // MyDbContext sýnýfýný dahil et
...
// DbContext'i doðru þekilde ekle
builder.Services.AddDbContext<MyDbContext>(options =>
    options.UseNpgsql(builder.Configuration.GetConnectionString("PostgreSqlConnection"))); // PostgreSQL baðlantýsý için baðlantý dizesi
...
// Reservation yönetimi için özel URL yönlendirmesi
app.MapControllerRoute(
...
app.MapControllerRoute(
    ...
    defaults: new { controller = "Home", action = "LoanHistory" });
